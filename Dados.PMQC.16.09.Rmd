---
title: "Dados PMQC - Setembro 2016"
author: ""
date: ""
output: pdf_document
classoption: a4paper
...
library(data.table)
mypath.1 <- "/Volumes/NO NAME/ExplAnalysis_PMQC/Dados.PMQC.16.09.pmqc.dt.csv"
mypath.2 <- "/Volumes/NO NAME/ExplAnalysis_PMQC/Dados.PMQC.16.09.pmqc.un.dt.csv"
...
**Dez maiores valores de ME20C para GCC-GCA:**

```{r ME20C.gcp,echo=FALSE,cache=TRUE,warning=FALSE}
pmqc.un.dt[Ensaio. == "ME20C" &
                   Produto %in% c("GASOLINA C ADITIVADA","GASOLINA C COMUM"),][order(-as.numeric(Resultado)),.(Contratada,Id.text,Resultado)][1:10,]
```

**Dez menores valores de ME20C para Etanol:**
